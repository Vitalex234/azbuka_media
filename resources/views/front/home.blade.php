                        ...
                        <div class="row row-flex">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <!-- About Block Image--><img
                                    src="{{ $text->where('name','about_image')->first()->image_url }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row row-flex">
                            ...
                            <div class="shop-item-container col-xs-12 col-sm-6">
                                <div class="shop-item-content">
                                    <div class="shop-item-content-image col-xs-12"><a href="#"><img
                                                src="/images/RN3.png" alt=""/></a>
                                    </div>
                                    <h5 class="col-xs-12"><a href="#">RGBLink обновила ассортимент компактных
                                            видеомикшеров Mini</a></h5>
                                    <p class="col-xs-12">Компания RGBLink представила видеомикшер mini-Pro, который
                                        пришел
                        ...
                        <div class="gallery-block gallery-block-masonry-gutter row">
                            ...
                            @foreach ($projects as $project)
                                <div class="gallery-block-item col-xs-12 col-sm-6 col-lg-3 computer"><a
                                        href="{{route('projectItem', ['projectAlias' => $project->alias]) }}"><img src="/uploads/{{$project->thumbnail('small','image')}}"
                                                                      alt="{{$project->title}}"/>
